...
exports.MeetingExtractionAgent = void 0;
const BaseAgent_1 = require("../base/BaseAgent");
const generative_ai_1 = require("@google/generative-ai");
class MeetingExtractionAgent extends BaseAgent_1.BaseAgent {
    genAI;
    model;
    constructor(apiKey) {
        super('MeetingExtractionAgent', 'Extracts structured meeting details from Telegram messages using AI');
    ...
    async process(messageText) {
        try {
            ...
            this.handleError(error, { messageText });
        }
    }
    buildExtractionPrompt(messageText) {
...
- Ensure all required fields are present`;
    ...
    validateAndNormalize(extracted) {
...
exports.MeetingExtractionAgent = MeetingExtractionAgent;
//# sourceMappingURL=MeetingExtractionAgent.js.map